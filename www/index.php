...
<!--[if gt IE 9]><!--> <html lang="fr"> <!--<![endif]-->
	...
	<body>
		...
		<section class="c-home o-section -color">
			...
			<img class="o-watch" src="modules/memo/assets/images/watch.png">
			<img class="o-ipad" src="modules/memo/assets/images/ipad.png">
			<img class="o-iphone" src="modules/memo/assets/images/iphone.png">
		</section>
					...
					<div class="c-what_section">
						<div class="c-what_circle -text">
							<div class="c-circle-icon">
								...
								<div class="c-circle-icon_border"></div>
